 ...
 * substituted by the PronounTool class at runtime.
 */
const SampleTexts = {
  school: {
    title: "Schule",
...
[Vorname] lächelt: „Ja. Total gerne.“`,
  ...
  queerParty: {
    title: "Queere Party",
    text: `„Wo darf ich dir den Stempel hin machen?“ [Nominativ] streckte der Person am Empfang [poss. 3] linke Hand hin und bekam einen dunklen Einhornstempel verpasst.
...
„Leute, es ist einfach ein Poster.“ Anti widerspricht vehement, tut so, als würde Anti Nics zur Seite nehmen und flüstert laut hinter der Hand: „Weißt du, Nics, [Vorname] denkt immer, dass [poss. 2] Kram und so ganz normal ist, aber [nominativ] vergisst immer, wie unglaublich cool und inspirierend [nominativ] ist. Ich hör [poss. 3] Geschichten einfach immer gerne zu und witzig ist [nominativ] halt einfach auch noch, manchmal bin ich echt fertig, wie krass ein Mensch sein kann.“
...
Durch die offene Tür drangen die Geräusche und Gespräche der Praxis zu mir ins Zimmer. „[Anrede/Vorname + Nachname] wartet in Zimmer 3. Wir brauchen [poss. 2] Krankenkassenkarte noch einen Moment, sagen Sie [dativ], dass [nominativ] sie noch bei uns abholen muss. Aber behandeln Sie [akkusativ] erst einmal.“
...
Besonders hervorheben möchten wir außerdem [poss. 3] Support und tiefe Liebe für [poss. 2] Freund*innen und Wahlfamilie. [Vorname + Nachname], wir sind so froh, dass du du bist und du bleibst. Du bist genau richtig wie du bist!
...
Die Abteilungsleitung eröffnet das Meeting: „Guten Morgen zusammen. Ich hoffe, Sie alle hatten ein erholsames Wochenende. Heute Morgen möchte ich mit dem Hinweis starten, dass [Anrede/Vorname + Nachname] ab sofort die Pronomen [Bezeichnung] verwendet.“ Die Anwesenden nicken, einige machen sich eine Notiz. Dann geht es weiter.
